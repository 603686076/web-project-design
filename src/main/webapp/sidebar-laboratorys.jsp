...
<%--			</g>--%>
<%--		  </svg>--%>
		<img style="width: 40px; height: 40px" src="img/laboratory/chuangxin.png" alt="">
		</div>
		923 创新实验室
	  </li>
	  <li class="pay">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 40px; height: 40px" src="img/laboratory/yidongkaifa.png" alt="">
		</div>
		925 移动开发实验室
	  </li>
	  <li class="wrap">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 40px; height: 40px" src="img/laboratory/jiqiren.png" alt="">
		</div>
		926 机器人实验室
	  </li>
	</ul>
