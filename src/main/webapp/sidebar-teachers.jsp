...
<%--			</g>--%>
<%--		  </svg>--%>
		<img style="width: 40px; height: 40px" src="img/icons/professor.png" alt="">
		</div>
		教授
	  </li>
	  <li class="pay">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 40px; height: 40px" src="img/icons/associateProfessor.png" alt="">
		</div>
		副教授
	  </li>
	  <li class="wrap">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 40px; height: 40px" src="img/icons/lecturer.png" alt="">
		</div>
		讲师
	  </li>
	</ul>
