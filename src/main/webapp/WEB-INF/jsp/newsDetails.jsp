...
<div class="main">
    <h1 style="text-align: center; padding: 15px 0px" >${anew.title}</h1><br>
    <div style="margin-left: 60px"><span class="badge badge-primary" style="background-color: #007bff">发布时间:</span> <fmt:formatDate type="both"
                        ...
                        value="${anew.releaseTime}" /></div>
    <br>
    <hr>
    <div style="padding: 4px 60px"><span class="badge badge-primary" style="background-color: #007bff">摘要:</span> <br> ${anew.summary}</div>
    <div  style="padding: 50px 60px"><span class="badge badge-primary" style="background-color: #007bff">正文:</span> ${anew.text}</div>
</div>
