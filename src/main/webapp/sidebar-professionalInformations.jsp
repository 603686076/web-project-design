...
<%--			</g>--%>
<%--		  </svg>--%>
		<img style="width: 30px; height: 30px" src="img/professionalInformation/zhuanyejianjie.png" alt="">
		</div>
		  专业简介
	  </li>
	  <li class="pay">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 30px; height: 30px" src="img/professionalInformation/fangxiangjianjie.png" alt="">
		</div>
		方向简介
	  </li>
	  <li class="wrap">
...
<%--			</g>--%>
<%--		  </svg>--%>
	<img style="width: 30px; height: 30px" src="img/professionalInformation/zhuanyefenliu.png" alt="">
		</div>
		专业分流
	  </li>
	</ul>
